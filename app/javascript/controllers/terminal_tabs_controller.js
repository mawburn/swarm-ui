...
export default class extends Controller {
  ...
  openTerminalPicker(event) {
    ...
    const gitStatusButton = document.querySelector(
      '[data-controller="dropdown-hover"][data-dropdown-hover-has-items-value="true"]'
    );
    if (gitStatusButton) {
  ...
  addTerminalTab(terminal) {
    ...
    tab.className =
      'group px-4 py-2 bg-gray-900 text-gray-300 border-r border-gray-700 flex items-center space-x-2 hover:bg-gray-800 hover:text-white transition-colors min-w-0 relative cursor-pointer';
